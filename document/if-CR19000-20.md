...
```ruby
@sign << ["CR19000-20", "接口配置"]
@sign << ["CR19000-20", "特殊接口配置"]
@sign << ["CR19000-20", "物理接口配置"]
@sign << ["CR19000-20", "子接口配置"]
@sign << ["CR19000-20", "接口分捡"]
@sign << ["CR19000-20", "端口识别"]
@sign << ["CR19000-20", "端口管理状态"]
@sign << ["CR19000-20", "接口地址"]
@sign << ["CR19000-20", "接口描述"]
@sign << ["CR19000-20", "接口vpn实例"]
@sign << ["CR19000-20", "接口开关"]
@sign << ["CR19000-20", "接口QoS"]
@sign << ["CR19000-20", "接口流策略"]
@sign << ["CR19000-20", "接口统计"]
@sign << ["CR19000-20", "接口URPF"]
@sign << ["CR19000-20", "接口接入类型"]
@sign << ["CR19000-20", "聚合接口判定"]
@sign << ["CR19000-20", "聚合接口分捡"]
@sign << ["CR19000-20", "聚合逻辑接口"]
@sign << ["CR19000-20", "vlan分捡"]
@sign << ["CR19000-20", "vlan统计"]
