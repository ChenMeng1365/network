...
```ruby
@sign << ["ZXCTN9000-18EA", "接口配置"]
@sign << ["ZXCTN9000-18EA", "接口物理信息"]
@sign << ["ZXCTN9000-18EA", "接口基本信息"]
@sign << ["ZXCTN9000-18EA", "接口vlan信息"]
@sign << ["ZXCTN9000-18EA", "接口acl信息"]
@sign << ["ZXCTN9000-18EA", "接口mpls信息"]
@sign << ["ZXCTN9000-18EA", "接口lacp信息"]
@sign << ["ZXCTN9000-18EA", "接口isis信息"]
@sign << ["ZXCTN9000-18EA", "接口multicast信息"]
@sign << ["ZXCTN9000-18EA", "接口firload信息"]
@sign << ["ZXCTN9000-18EA", "接口port_request_info信息"]
@sign << ["ZXCTN9000-18EA", "接口arp信息"]
@sign << ["ZXCTN9000-18EA", "接口nd信息"]
@sign << ["ZXCTN9000-18EA", "接口interface_performance信息"]
@sign << ["ZXCTN9000-18EA", "接口ospf信息"]
@sign << ["ZXCTN9000-18EA", "接口urpf信息"]
@sign << ["ZXCTN9000-18EA", "接口am信息"]
@sign << ["ZXCTN9000-18EA", "接口uim信息"]
@sign << ["ZXCTN9000-18EA", "接口QoS"]
@sign << ["ZXCTN9000-18EA", "接口流策略"]
@sign << ["ZXCTN9000-18EA", "接口统计"]
@sign << ["ZXCTN9000-18EA", "接口URPF"]
@sign << ["ZXCTN9000-18EA", "接口接入类型"]
@sign << ["ZXCTN9000-18EA", "特殊接口配置"]
@sign << ["ZXCTN9000-18EA", "物理接口配置"]
@sign << ["ZXCTN9000-18EA", "子接口配置"]
@sign << ["ZXCTN9000-18EA", "接口分捡"]
@sign << ["ZXCTN9000-18EA", "端口识别"]
@sign << ["ZXCTN9000-18EA", "端口MAC"]
@sign << ["ZXCTN9000-18EA", "端口管理状态"]
@sign << ["ZXCTN9000-18EA", "接口描述"]
@sign << ["ZXCTN9000-18EA", "接口地址"]
@sign << ["ZXCTN9000-18EA", "接口开关"]
@sign << ["ZXCTN9000-18EA", "接口vpn实例"]
@sign << ["ZXCTN9000-18EA", "聚合接口判定"]
@sign << ["ZXCTN9000-18EA", "聚合接口分捡"]
@sign << ["ZXCTN9000-18EA", "聚合逻辑接口"]
@sign << ["ZXCTN9000-18EA", "vlan分捡"]
@sign << ["ZXCTN9000-18EA", "vlan统计"]
@sign << ["ZXCTN9000-18EA", "端口去0"]
@sign << ["ZXCTN9000-18EA", "统计接口"]
