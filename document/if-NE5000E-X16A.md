...
```ruby
@sign << ["NE5000E-X16A", "接口配置"]
@sign << ["NE5000E-X16A", "特殊接口配置"]
@sign << ["NE5000E-X16A", "物理接口配置"]
@sign << ["NE5000E-X16A", "子接口配置"]
@sign << ["NE5000E-X16A", "接口分捡"]
@sign << ["NE5000E-X16A", "端口识别"]
@sign << ["NE5000E-X16A", "端口MAC"]
@sign << ["NE5000E-X16A", "端口管理状态"]
@sign << ["NE5000E-X16A", "接口描述"]
@sign << ["NE5000E-X16A", "接口地址"]
@sign << ["NE5000E-X16A", "接口开关"]
@sign << ["NE5000E-X16A", "接口vpn实例"]
@sign << ["NE5000E-X16A", "接口QoS"]
@sign << ["NE5000E-X16A", "接口流策略"]
@sign << ["NE5000E-X16A", "接口统计"]
@sign << ["NE5000E-X16A", "接口URPF"]
@sign << ["NE5000E-X16A", "接口接入类型"]
@sign << ["NE5000E-X16A", "聚合接口判定"]
@sign << ["NE5000E-X16A", "聚合接口分捡"]
@sign << ["NE5000E-X16A", "聚合逻辑接口"]
@sign << ["NE5000E-X16A", "聚合接口查询"]
@sign << ["NE5000E-X16A", "vlan分捡"]
@sign << ["NE5000E-X16A", "vlan统计"]
@sign << ["NE5000E-X16A", "统计接口"]
