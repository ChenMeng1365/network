...
```ruby
@sign << ["ME60-X16", "接口配置"]
@sign << ["ME60-X16", "特殊接口配置"]
@sign << ["ME60-X16", "物理接口配置"]
@sign << ["ME60-X16", "子接口配置"]
@sign << ["ME60-X16", "接口分捡"]
@sign << ["ME60-X16", "端口识别"]
@sign << ["ME60-X16", "端口MAC"]
@sign << ["ME60-X16", "端口管理状态"]
@sign << ["ME60-X16", "接口描述"]
@sign << ["ME60-X16", "接口地址"]
@sign << ["ME60-X16", "接口开关"]
@sign << ["ME60-X16", "接口vpn实例"]
@sign << ["ME60-X16", "接口QoS"]
@sign << ["ME60-X16", "接口流策略"]
@sign << ["ME60-X16", "接口统计"]
@sign << ["ME60-X16", "接口URPF"]
@sign << ["ME60-X16", "接口接入类型"]
@sign << ["ME60-X16", "聚合接口判定"]
@sign << ["ME60-X16", "聚合接口分捡"]
@sign << ["ME60-X16", "聚合逻辑接口"]
@sign << ["ME60-X16", "聚合接口查询"]
@sign << ["ME60-X16", "vlan分捡"]
@sign << ["ME60-X16", "vlan统计"]
@sign << ["ME60-X16", "统计接口"]
...
module ME60_X16
  ...
  def 聚合接口查询 查询报文
    ...
    parts = 查询报文.split("--------------------------------------------------------------------------------")
    return parts[1].split("\n").map{|s|s.split(" ")}.select{|s|s.size>1}.map{|s|s.first.split('(').first}.select{|s|!s.include?('Port')}
  end
