...
```ruby
@sign << ["NE8100-X8", "接口配置"]
@sign << ["NE8100-X8", "特殊接口配置"]
@sign << ["NE8100-X8", "物理接口配置"]
@sign << ["NE8100-X8", "子接口配置"]
@sign << ["NE8100-X8", "接口分捡"]
@sign << ["NE8100-X8", "端口识别"]
@sign << ["NE8100-X8", "端口MAC"]
@sign << ["NE8100-X8", "端口管理状态"]
@sign << ["NE8100-X8", "接口描述"]
@sign << ["NE8100-X8", "接口地址"]
@sign << ["NE8100-X8", "接口开关"]
@sign << ["NE8100-X8", "接口vpn实例"]
@sign << ["NE8100-X8", "接口QoS"]
@sign << ["NE8100-X8", "接口流策略"]
@sign << ["NE8100-X8", "接口统计"]
@sign << ["NE8100-X8", "接口URPF"]
@sign << ["NE8100-X8", "接口接入类型"]
@sign << ["NE8100-X8", "聚合接口判定"]
@sign << ["NE8100-X8", "聚合接口分捡"]
@sign << ["NE8100-X8", "聚合逻辑接口"]
@sign << ["NE8100-X8", "聚合接口查询"]
@sign << ["NE8100-X8", "vlan分捡"]
@sign << ["NE8100-X8", "vlan统计"]
@sign << ["NE8100-X8", "统计接口"]
