...
```ruby
@sign << ["MA5200G-8", "接口配置"]
@sign << ["MA5200G-8", "特殊接口配置"]
@sign << ["MA5200G-8", "物理接口配置"]
@sign << ["MA5200G-8", "子接口配置"]
@sign << ["MA5200G-8", "接口分捡"]
@sign << ["MA5200G-8", "端口识别"]
@sign << ["MA5200G-8", "端口MAC"]
@sign << ["MA5200G-8", "端口管理状态"]
@sign << ["MA5200G-8", "接口描述"]
@sign << ["MA5200G-8", "接口地址"]
@sign << ["MA5200G-8", "接口开关"]
@sign << ["MA5200G-8", "接口vpn实例"]
@sign << ["MA5200G-8", "接口QoS"]
@sign << ["MA5200G-8", "接口流策略"]
@sign << ["MA5200G-8", "接口统计"]
@sign << ["MA5200G-8", "接口URPF"]
@sign << ["MA5200G-8", "接口接入类型"]
@sign << ["MA5200G-8", "聚合接口判定"]
@sign << ["MA5200G-8", "聚合接口分捡"]
@sign << ["MA5200G-8", "聚合逻辑接口"]
@sign << ["MA5200G-8", "聚合接口查询"]
@sign << ["MA5200G-8", "vlan分捡"]
@sign << ["MA5200G-8", "vlan统计"]
@sign << ["MA5200G-8", "统计接口"]
