...
```ruby
@sign << ["CX600-X8A", "接口配置"]
@sign << ["CX600-X8A", "特殊接口配置"]
@sign << ["CX600-X8A", "物理接口配置"]
@sign << ["CX600-X8A", "子接口配置"]
@sign << ["CX600-X8A", "接口分捡"]
@sign << ["CX600-X8A", "端口识别"]
@sign << ["CX600-X8A", "端口MAC"]
@sign << ["CX600-X8A", "端口管理状态"]
@sign << ["CX600-X8A", "接口描述"]
@sign << ["CX600-X8A", "接口地址"]
@sign << ["CX600-X8A", "接口开关"]
@sign << ["CX600-X8A", "接口vpn实例"]
@sign << ["CX600-X8A", "接口QoS"]
@sign << ["CX600-X8A", "接口流策略"]
@sign << ["CX600-X8A", "接口统计"]
@sign << ["CX600-X8A", "接口URPF"]
@sign << ["CX600-X8A", "接口接入类型"]
@sign << ["CX600-X8A", "聚合接口判定"]
@sign << ["CX600-X8A", "聚合接口分捡"]
@sign << ["CX600-X8A", "聚合逻辑接口"]
@sign << ["CX600-X8A", "vlan分捡"]
@sign << ["CX600-X8A", "vlan统计"]
@sign << ["CX600-X8A", "统计接口"]
