...
```ruby
@sign << ["NE40E-X16", "接口配置"]
@sign << ["NE40E-X16", "特殊接口配置"]
@sign << ["NE40E-X16", "物理接口配置"]
@sign << ["NE40E-X16", "子接口配置"]
@sign << ["NE40E-X16", "接口分捡"]
@sign << ["NE40E-X16", "端口识别"]
@sign << ["NE40E-X16", "端口MAC"]
@sign << ["NE40E-X16", "端口管理状态"]
@sign << ["NE40E-X16", "接口描述"]
@sign << ["NE40E-X16", "接口地址"]
@sign << ["NE40E-X16", "接口开关"]
@sign << ["NE40E-X16", "接口vpn实例"]
@sign << ["NE40E-X16", "接口QoS"]
@sign << ["NE40E-X16", "接口流策略"]
@sign << ["NE40E-X16", "接口统计"]
@sign << ["NE40E-X16", "接口URPF"]
@sign << ["NE40E-X16", "接口接入类型"]
@sign << ["NE40E-X16", "聚合接口判定"]
@sign << ["NE40E-X16", "聚合接口分捡"]
@sign << ["NE40E-X16", "聚合逻辑接口"]
@sign << ["NE40E-X16", "聚合接口查询"]
@sign << ["NE40E-X16", "vlan分捡"]
@sign << ["NE40E-X16", "vlan统计"]
@sign << ["NE40E-X16", "统计接口"]
